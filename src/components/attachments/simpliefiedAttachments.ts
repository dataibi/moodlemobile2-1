...
/**
 * Component to render attachments in a simplified version, allow adding more and delete the current ones.
 *
 ...
 *
 * <core-simplified-attachments [files]="files" [maxSize]="configs.maxsubmissionsizebytes"
 *     [maxSubmissions]="configs.maxfilesubmissions" [component]="component" [componentId]="assign.cmid"
 *     [acceptedTypes]="configs.filetypeslist" [allowOffline]="allowOffline">
 * </core-simplified-attachments>
 */
@Component({
    selector: 'core-simplified-attachments',
    templateUrl: 'core-simplified-attachments.html'
})
export class CoreSimplifiedAttachmentsComponent implements OnInit {
