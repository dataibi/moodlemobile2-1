...
import { AddonModAssignProvider } from '@addon/mod/assign/providers/assign';
import { AddonModAssignOfflineProvider } from '@addon/mod/assign/providers/assign-offline';
import { AddonModAssignSyncProvider } from '@addon/mod/assign/providers/assign-sync';
import { AddonModAssignHelperProvider } from '@addon/mod/assign/providers/helper';

/**
 * Page that allows adding or editing an assigment submission.
 */
@Component({
    selector: 'page-addon-mod-assign-edit-submission',
    templateUrl: 'edit-submission.html',
})
export class AddonModAssignEditSubmissionComponent implements OnInit, OnDestroy {

    @Input() moduleId: number;
    @Input() courseId: number;
    @Input() blindId: number;
